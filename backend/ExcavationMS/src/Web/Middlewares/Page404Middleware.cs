...
public class Page404Middleware
{
    private readonly RequestDelegate                 _next;
    private readonly ConfigurationOptions.AppOptions _appConfig;

    public Page404Middleware(RequestDelegate next, IOptions<ConfigurationOptions.AppOptions> appConfig)
    {
        _next      = next;
    ...
    public async Task InvokeAsync(HttpContext context)
    {
        ...
        if (context.Response.StatusCode == (int)HttpStatusCode.NotFound)
        {
            ...
            const string signature = "Page Not Found";
